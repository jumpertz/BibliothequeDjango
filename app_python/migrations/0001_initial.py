# Generated by Django 3.2.16 on 2023-02-08 21:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('groups', models.ManyToManyField(related_name='auth_groups', to='auth.Group')),
                ('user_permissions', models.ManyToManyField(related_name='auth_permissions', to='auth.Permission')),
            ],
            options={
                'db_table': 'users',
            },
